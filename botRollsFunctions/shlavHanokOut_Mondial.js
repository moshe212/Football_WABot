...
const shlavHanokOut_Mondial = async function (
  message,
  cycleDate,
  cycleText,
  cycleNum,
    ...
    case 480:
      if (cycleNum !== "0" && cycleText.includes("שלב הנוקאאוט")) {
        ...
        if (cycleText.includes("שלב הנוקאאוט")) {
          textMessage1 =
            "שומעים רגע? הדד ליין לשליחת הניחושים לשלב" + "*" + cycleNum ===
            "גמר ומקום 3"
              ? "משחק הגמר והמשחק על המקום ה-3"
              : cycleNum + "*" + " עבר.";
          textMessage2 =
...
module.exports = { shlavHanokOut_Mondial };
